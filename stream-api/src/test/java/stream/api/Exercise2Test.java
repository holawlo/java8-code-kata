...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Stream<Integer> sortedAgeStream = customerList.stream().map(Customer::getAge).sorted(); //nat. asc! to bez parametrow
    ...
    public void descSortByAge() {
         ...
         */
        Comparator<Integer> descOrder = (a, b) -> a - b;
    ...
    public void top3RichCustomer() {
         ...
         */
        Stream<String> top3RichCustomerStream = customerList.stream().sorted((a, b) -> b.getBudget() - a.getBudget()).limit(3).map(Customer::getName); //w obiekcie Stream nie trzeba collecta
    ...
    public void itemsCustomersWantToBuy() {
        ...
        Stream<String> itemStream = customerList.stream().flatMap(getItemStream).map(i -> i.getName());
